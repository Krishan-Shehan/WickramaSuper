...
export default function OfferTable() {
    ...
    const columns = [
        {title: "ID", field: "id"},
        {title: "Offer name", field: "offer_name"},
        {title: "Offer days", field: "offer_days"},
        {title: "Offer details", field: "offer_details"}
    ];
    ...
    const handleRowUpdate = (newData, oldData, resolve) => {
        ...
        if(errorList.length < 2){
            ...
            axios.put('/api/offers/'+newData.id, newData)
    ...
    const handleRowDelete = (oldData, resolve) => {
        axios.delete('/api/offers/'+oldData.id)
